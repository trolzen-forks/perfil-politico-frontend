<template>
  <footer class="c-footer bg-primary-base p-10 bottom-0">
    <div class="c-footer__content container bg-background-purpleLight flex flex-col sm:flex-row justify-center items-center p-5 text-white rounded-lg">
      ...
      <div class="c-footer__content-link-project flex w-full sm:w-auto items-center justify-center bg-opacity-10 bg-white p-3 rounded-lg">
        <img src="@/assets/icons/icon-github.svg" alt="Github" />
        <span><a href="http://" target="_blank" rel="noopener noreferrer" class="ml-2">Ver Github</a></span>
      </div>
    </div>
